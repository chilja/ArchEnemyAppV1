...
import net.archenemy.archenemyapp.data.BitmapSharable;
import net.archenemy.archenemyapp.data.BitmapShareListener;
...
import net.archenemy.archenemyapp.data.FacebookShareListener;
import net.archenemy.archenemyapp.data.TextSharable;
import net.archenemy.archenemyapp.data.TextShareListener;
...
public class Tweet 
	...
	public View getView(Activity activity){
    	...
    	// URL provided? -> load bitmap
    		...
    		DataAdapter.loadBitmap(mImageUrl, mImageView, this, 600, 600);
	...
	private void zoomImageFromThumb(final View thumbView, View layout) {
	    ...
	    final ImageView expandedImageView = (ImageView) layout.findViewById(
	            R.id.expandedImage);
	    DataAdapter.loadBitmap(mImageUrl, expandedImageView, this, 400, 400);
