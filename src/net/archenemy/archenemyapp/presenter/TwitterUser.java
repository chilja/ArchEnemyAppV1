...
public class TwitterUser implements 
	...
	public View getView(Activity activity){
	    ...
	    final View layout = inflater.inflate(R.layout.twitter_user, null);
	    
	    TextView nameView = (TextView) layout.findViewById(R.id.nameView);
		TextView userNameView = (TextView) layout.findViewById(R.id.userNameView);
    	...
    	// URL provided? -> load bitmap
    		...
    		BitmapUtility.loadBitmap(mImageUrl, mImageView, 100, 100);
    	} 
    	...
    	mImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                zoomImageFromThumb(mImageView, layout);
            }
        });
	...
	private void zoomImageFromThumb(final View thumbView, View layout) {
	    ...
	    final ImageView expandedImageView = (ImageView) layout.findViewById(
	            R.id.expanded_image);
	    BitmapUtility.loadBitmap(mImageUrl, expandedImageView, 100, 100);
